...
function createGameplay(ID, imgURL, imgAlt, title, description, description2) {
    ...
    clone.querySelector('.d2').textContent = description2;
...
// UI/UX Section
createGameplay('uiux-container', "Assets/CraftingMechanic.gif", "Inventory and Crafting System", "Inventory and Crafting System",
    "[Describe Inventory and Crafting System mechanic]",
...
createGameplay('uiux-container', "Assets/Notes.gif", "Note Interface", "Inventory and Note Interface",
    "[Describe Note mechanic]",
...
createGameplay('uiux-container', "Assets/Hero'sParry.gif", "Main Menu", "Main Menu",
    "[Describe Main Menu]",
    "A simple main menu where the player can start the game or quit. I designed all the visuals of the main menu and made it so that the opacity changes when hovering over one of the buttons. When a button is clicked on, the colors change to indicate that it has been pressed, and this color scheme mimics the parry mechanic in the game.");

createGameplay('uiux-container', "Assets/MissedHarvest.gif", "Settings Menu", "Settings Menu",
...
// Gameplay Section
createGameplay('gameplay-container', "Assets/Fishing.gif", "Fishing mechanic", "Fishing System",
    "This clip showcases the fishing system that I implemented in my latest game CraftAway.",
...
createGameplay('gameplay-container', "Assets/BossMechanics.gif", "Boss fighting mechanics", "Boss Fighting Mechanics",
    "This clip showcases the boss Treevil from my latest game CraftAway.",
    "I programmed the boss attacks, created the sprites, and worked on the boss summoning mechanic.");

createGameplay('gameplay-container', "Assets/PlantGrowthMechanic.gif", "Plant growing mechanics", "Plant Growth System",
    "This clip showcases the plant growth system from my game Farm Game.",
...
createGameplay('gameplay-container', "Assets/MoneyGun.gif", "Money gun mechanic", "Money Gun Mechanic and Physics",
    "This clip showcases the money gun mechanic from my game Materialism Attacks!",
